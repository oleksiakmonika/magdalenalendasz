...
const Contact = () => {
    return (
        <>
            <Header/>
            <h1>kontakt</h1>
            <p>Gdańsk Śródmieście (okolice Dworca Głównego)
                ul. Dyrekcyjna 6, p. nr 209 (II piętro)

                tel. 503 11 33 24
                e-mail: psycholog@magdalenalendasz.pl

                Termin pierwszego spotkania można ustalić telefonicznie lub poprzez e-mail.
